...
public class WindChill {
	public static void main(String[] args) {
    	...
    	/*
    	 * It should print the wind chill w using the following formula
    	 *  careful to add all three * signs:
    	 */
    	 double w = 35.74 + 0.62158 * t + (0.4275 * t - 35.75) * Math.pow(v, 0.16);    //Use Math.pow to compute the exponent
